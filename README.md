...
> **Student Name:** `Sarthak singh thakur`  
> **Roll Number:** `24bce10507`  
...
The shell scripts in this repository are released under the **MIT License** — you are free to use, modify, and distribute them.

The written report (`python_open_source_audit.docx`) is the original academic work of the student named above and is submitted for assessment at VITyarthi. It is not licensed for redistribution.
